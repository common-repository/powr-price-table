...
Price Table lets you promote product features and pricing in a custom comparison table. Even link shoppers to a purchase page or PayPal checkout.

== Description ==
= DOWNLOAD, INSTALL & ACTIVATE > CUSTOMIZE IN MINUTES > ADD PRICE TABLE TO SITE =
<br>
<br>
[youtube https://www.youtube.com/watch?v=E90-93DLT6E]
<br>
<br>
Sell more with side-by-side pricing tables
<br>
<br>
= Free Features =
...
= <a href='https://www.powr.io/plugins/price-table'>More Info</a> =
<br>

= LIVE EDITING =
POWr Price Table plugin is simple to customize, directly inside of your live WordPress website. Just click on the Settings Icon to open the POWr Editor. You can now edit the design and contents of your Price Table plugin. See your changes in real time, on your actual site. No need to ever leave the page. Just edit and save right in the POWr Editor.
<br>
= MOBILE RESPONSIVE =
Mobile traffic matters. And successful sites need to be mobile responsive to keep up. The Price Table plugin is optimized to function beautifully on almost any device. So you can spend less time worrying about how people are searching your site, and more about what they'll discover.
<br>
= CUSTOMIZABLE =
...
== Installation ==
Download, Install and Activate POWr Price Table.
<br>
<br>
A POWr account will automatically be created for you and you will see the POWr Editor in WordPress, where you can build and customize your Price Table.
<br>
<br>
...
5. To import a Price Table you have already saved, click **Import Existing Price Table**, find your Plugin and click **Copy**. Your Price Table is now on your WordPress site.
...
= How do I add Price Table to a page or blog post? =
...
= How do I add Price Table to a theme? =
1. Go to your WordPress Dashboard and select Appearance and Widgets from the dropdown menu.
2. Drag and drop your plugin into any sidebar or footer, then **Save**.
3. Visit your live site by clicking the home button in the upper left-hand side and click **Visit Site**.
4. Find the plugin and click on the **Edit** button. This will open the POWr Editor.
...
= Can I add more than one Price Table? =
Yes, absolutely!  To clone an existing Price Table, paste the exact same unique shortcode into another page or post.  To create a new version, select Price Table from the sidebar in your WP Dashboard and click Create New.  You can then edit and save a new version, and paste the new unique shortcode into a page or post.

= Will my users see the Edit button above Price Table? =
...
= Is POWr Price Table Free? =
Yes, the basic version of Price Table is completely free!
